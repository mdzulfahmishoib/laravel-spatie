        ...
        <div class="row p-4">
            <div class="col">
                <div class="align-items-center text-center">
                    <img id="preview" src="{{ asset('img/default_user.jpg') }}" alt="Foto Profil" width="150" class="mt-3 img-circle elevation-2">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div style="background-color: #E9ECEF;" class="p-3 rounded text-center">
                            ...
                            <p class="mb-0" id="show_terdaftar"></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @csrf
                <div class="mb-3">
                    ...
                    <input for="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan Nama" required value="{{ old('name') }}" autofocus>
                    @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="mb-3">
                    <label for="">Username<span class="text-danger"> *</span></label>
                    <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Masukkan Username" required value="{{ old('username') }}">
                    @error('username') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="mb-3">
                    <label for="">Email<span class="text-danger"> *</span></label>
                    <input for="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Masukkan Email" required value="{{ old('email') }}">
