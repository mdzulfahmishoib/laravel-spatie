...
class RoleController extends Controller implements HasMiddleware
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('management_user/roles')->with('success', 'Role Berhasil Dibuat');
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect('management_user/roles')->with('success', 'Role Berhasil Diperbarui');
    }
    ...
    public function destroy($roleId)
    {
        ...
        return redirect('management_user/roles')->with('success', 'Role Berhasil Dihapus');
    }
    ...
    public function givePermissionToRole(Request $request, $roleId)
    {
        ...
        return redirect()->back()->with('success', 'Permission Berhasil di Tambahkan');
    }
