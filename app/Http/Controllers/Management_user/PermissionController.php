...
class PermissionController extends Controller implements HasMiddleware
{
    ...
    public function update(Request $request, Permission $permission){
        ...
        return redirect('management_user/permission')->with('success', 'Permission Berhasil Diperbarui');
    }
    ...
    public function destroy($permissionId){
        ...
        return redirect('management_user/permission')->with('success', 'Permission Berhasil Dihapus');
